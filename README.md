...
When using our app, DO NOT refresh the page after logging in as this will automaticall log you out of our web application. If you accidentally refreshed the page, go to the Navigation Bar and log in again
